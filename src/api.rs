...
use crate::generator::{Image, SlideContent, create_pptx_with_content};
...
impl Presentation {
    ...
    /// Set the presentation slide size
    pub fn slide_size(mut self, size: Option<Size>) -> Self {
    ...
    pub fn get_slide_size(&self) -> Option<Size> {
        self.slide_size
    }
